...
{
	read_decrypt_mul_encrypt_write_encrypted_rand_prod( "/home/nuplavikar/temp/interm_files/3.txt", "mp_test_op_02.txt", "/home/nuplavikar/IdeaProjects/DocSimilaritySecureApp/keys.txt");
